...
Class: CulturalNetwork          
  - networkID: string          
  - region: string          
  - culturalDiversityIndex: float        // new data property          
  - predominantReligion: string          // new data property          
...
Class: Province          
  ...
  - provinceName: string          
  - population: int          
  - localGDP: float                     // new data property          
          
Class: City          
  - cityID: string          
  - cityName: string          
  - citySize: string          
  - foundingYear: int                   // new data property          
...
/*           
We only needed 5 new object properties, so let's finalize them carefully:          

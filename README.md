...
* Here's a #starwars ontology for you to explore: [**Star Wars**](https://github.com/shauryashaurya/The-Silmaril/tree/main/o-1000-StarWars)                  
* ...and while we were on the topic of Palantir, it's natural that we build a LOTR ontology as well: [**The Lord Of The Rings**](https://github.com/shauryashaurya/The-Silmaril/tree/main/o-1001-The-Lord-of-the-Rings)                
...
* The [CS520: Knowledge Graphs Seminar Plalist](https://www.youtube.com/playlist?list=PLDhh0lALedc5paY4N3NRZ3j_ui9foL7Qc)       
...
* [Notes on Palantir Foundry's Ontology](https://publish.obsidian.md/followtheidea/Content/AI/Ontology+Palantir+-+notes#weak+points+of+ontology)

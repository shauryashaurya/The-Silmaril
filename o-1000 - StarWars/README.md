...
```pseudocode                        
// ======================
// Star Wars Ontology (Episodes 4,5,6) - Extended with Constraints
// ======================
...
// ========== OBJECT PROPERTIES (existing + new) ==========
...
// Additional constraints for newly added or updated properties:
